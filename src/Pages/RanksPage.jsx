...
const UserRankings = () => {
  ...
  return (
    <div className="p-4 sm:p-8 max-w-5xl mx-auto dark:bg-black" >
      <h2 className="text-2xl font-bold text-center mb-6 dark:bg-black dark:text-white">🏆 User Rankings</h2>
      <div className="overflow-x-auto">
        <table className="min-w-full border border-gray-300 text-sm sm:text-base">
          <thead className="bg-gray-200 dark:text-white">
            <tr>
