  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-black px-4 sm:px-6 md:px-8">
      <motion.div
        ...
        animate={{ opacity: 1, scale: 1 }}
        transition={{ duration: 0.5, ease: "easeOut" }}
        className="w-full max-w-lg bg-white dark:bg-gray-800 shadow-lg rounded-xl p-6 sm:p-8 md:p-10 border border-gray-200 dark:border-gray-700"
      >
        <motion.div
          initial={{ y: -20, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
        ...
        <motion.p
          ...
          animate={{ y: 0, opacity: 1 }}
          transition={{ duration: 0.4, delay: 0.4 }}
          className="mt-2 text-center text-gray-600 dark:text-gray-300 text-sm sm:text-base"
        >
          Already have an account?&nbsp;
          <Link to="/login" className="text-blue-500 hover:underline">
            Sign In
        ...
        {msg && <p className="text-green-500 mt-4 text-center text-sm sm:text-base">{msg}</p>}
