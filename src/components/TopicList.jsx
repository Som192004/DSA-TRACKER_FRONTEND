...
const TopicList = ({ data }) => {
    ...
    const saveChanges = () => {
        ...
        const problemId = editingProblemId;
        axios
            .patch(`https://dsa-tracker-backend-oo1y.onrender.com/userprogress/update-userprogress/${problemId}`, {
                editedProblem,
        ...
        <>
            <div className="dark:bg-black px-4 sm:px-6">
                <h1 className="text-3xl sm:text-4xl text-center dark:text-white pb-2">
                    {problemList[0]?.problemDetails?.topicName}
                </h1>
            </div>
            <div className="flex justify-center dark:bg-black px-2">
                <div className="overflow-x-auto w-full">
                    <table className="table-auto w-full border-collapse border-2 border-black dark:border-white dark:bg-black mb-2 text-sm sm:text-base">
                        <thead>
                            <tr>
                                <th className="border-2 border-black dark:border-white dark:text-white px-2 py-1">Topic</th>
                                <th className="border-2 border-black dark:border-white dark:text-white px-2 py-1">Problem</th>
                                <th className="border-2 border-black dark:border-white dark:text-white px-2 py-1">Difficulty</th>
                            ...
                            {problemList?.map((problemData) => (
                                <tr key={problemData?.list?._id}>
                                    <td className="border-2 border-black dark:border-white dark:text-white px-2 py-1">
                                        {problemData?.problemDetails?.topicName}
                                    </td>
                                    <td className="border-2 border-black dark:border-white dark:text-white px-2 py-1">
                                        {problemData?.problemDetails?.name}
                                    </td>
                                    <td className="border-2 border-black dark:border-white dark:text-white px-2 py-1">
                                        {problemData?.problemDetails?.difficulty}
                                    </td>
                                    <td className="border-2 border-black dark:border-white dark:text-white px-2 py-1 text-center">
                                        <input
                                            ...
                                            checked={
                                                editingProblemId === problemData?.list?._id
                                                    ? editedProblem?.status === "Solved"
                                                    : problemData?.list?.status === "Solved"
                                            }
                                            onChange={(e) => {
                                                if (editingProblemId === problemData?.list?._id) {
                                                    setEditedProblem((prev) => ({
                                    ...
                                    <td className="border-2 border-black dark:border-white dark:text-white px-2 py-1 text-center">
                                        <a href={problemData?.problemDetails?.link} target="_blank" rel="noopener noreferrer">
                                            <img width="32" height="32" src="https://img.icons8.com/color/48/GeeksforGeeks.png" alt="GeeksforGeeks" />
                                        </a>
                                    </td>
                                    <td className="border-2 border-black dark:border-white dark:text-white px-2 py-1 text-center">
                                        {editingProblemId === problemData?.list?._id ? (
                                            ...
                                            <Button onClick={() => editProblem(problemData?.list)}>
                                                <FaEdit size="1.5em" />
                                            </Button>
                                        )}
                                    </td>
