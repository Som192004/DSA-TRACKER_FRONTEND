...
//                     <div className="text-2xl mb-1 dark:text-white mt-2">
//                         <h1>Total Problems Solved: {data?.totalProblems}</h1>
//                     </div>
//                     <hr />
//                     <div className="text-2xl mt-1 dark:text-white">
//                         <h1 className="mb-1">Topics Covered on (DSA TRACKER)</h1>
//                         <div className='flex flex-wrap'>
//                             {dsaTopics?.map((dsaTopic) => (
//                                 <div key={dsaTopic.id} className='p-2 w-full sm:w-1/2 lg:w-1/4 hover:scale-105 transition duration-300 cursor-pointer'>
//                                     <DSACard name={dsaTopic.name} number={data?.result[dsaTopic.id]} msg={"Problems solved"}/>
//                                 </div>
//                             ))}
//                         </div>
...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    const accessToken = localStorage.getItem("accessToken");
    axios
      .post("https://dsa-tracker-backend-oo1y.onrender.com/users/profile", {
        topicNames,
        Authorization: `${accessToken}`,
      })
      .then((response) => {
